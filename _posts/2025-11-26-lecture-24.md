...
<figure class="figure">
  <img src="{{ '/assets/img/notes/lecture-24/1.png' | relative_url }}" />
...
<figure class="figure">
  <img src="{{ '/assets/img/notes/lecture-24/2.png' | relative_url }}" />
  <figcaption><strong>Figure 1.</strong> GPT-2 performance on LAMBADA, CBT, and WikiText2 as model size increases (Radford et al., 2019).</figcaption>
</figure>
...
<figure class="figure">
  <img src="{{ '/assets/img/notes/lecture-24/3.png' | relative_url }}" />
  <figcaption><strong>Figure 1.</strong> GPT-2 performance on LAMBADA, CBT, and WikiText2 as model size increases (Radford et al., 2019).</figcaption>
</figure>
...
<figure class="figure">
  <img src="{{ '/assets/img/notes/lecture-24/4.png' | relative_url }}" />
  <figcaption><strong>Figure 1.</strong> GPT-2 performance on LAMBADA, CBT, and WikiText2 as model size increases (Radford et al., 2019).</figcaption>
</figure>
